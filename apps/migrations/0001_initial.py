# Generated by Django 5.2.2 on 2025-12-05 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (2, 'HR'), (3, 'Employee')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes_received', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Performance',
